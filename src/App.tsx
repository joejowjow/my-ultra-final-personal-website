...
const projects = [
  ...
  },
  {
    ...
    description: 'Bring your visions to reality through groundbreaking masterpieces.',
    videoUrl: 'https://drive.google.com/drive/folders/1_1dNxrttYBPCj05MmB7ZZ7HmT9uXjU6r?usp=drive_link',
  },
];
...
const App = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      {/* Hero Section */}
      <motion.section
        className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center bg-orange-600 text-white py-3 px-8 rounded-full font-bold hover:bg-orange-700 transition duration-300 transform hover:scale-105"
        >
          Hire Me
        </a>
      </motion.section>
      ...
      >
        ...
        <p className="text-lg mb-4">
          I am a passionate video editor and animator with a keen eye for detail.
        </p>
        <p className="text-lg">
          With years of experience, I specialize in creating engaging content that resonates with audiences.
        </p>
      </motion.section>
      ...
      >
        ...
        <p className="text-lg mb-4">Let's collaborate on something amazing!</p>
        <a
          href="mailto:yokyheikal@gmail.com"
          className="bg-green-600 text-white py-3 px-8 rounded-full font-bold hover:bg-green-700 transition duration-300 transform hover:scale-105"
        >
          Email Me
        </a>
      </motion.section>
